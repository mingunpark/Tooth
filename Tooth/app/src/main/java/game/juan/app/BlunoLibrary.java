		...
		mScanDeviceDialog = new AlertDialog.Builder(mainContext)
				.setTitle("BLE Device Scan...").setAdapter(mLeDeviceListAdapter, new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						...
						System.out.println("Device : "+mLeDeviceListAdapter.getDevice(which));
						if (device == null)
							return;
						scanLeDevice(false);
						...
						if (device.getName() == null || device.getAddress() == null) {
							...
							System.out.println("MAC : "+mDeviceAddress);
							System.out.println("mBluetoothLeService : "+mBluetoothLeService);

							if (mDeviceName.equals("TOOTH")) {
		...
		public void onLeScan(final BluetoothDevice device, int rssi,
			...
			((Activity) mainContext).runOnUiThread(new Runnable() {
				...
				public void run() {
					...
					if(device.getAddress().equals("50:65:83:90:07:F6")){
